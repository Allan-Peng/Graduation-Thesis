layui.config({
    ...
    //加载页面数据
    var newsData = '';
    $.get(serverUrl + "/PoliceChangPing/programInfo/getAllColumn", function (data) {
        var newArray = [];
    ...
    $(".btnAdd").click(function () {
        layui.layer.open({
            title: ['新建专栏', 'font-family: PingFangSC-Medium;font-size: 18px;color: #333333;text-align: center;'],
            type: 2,
            content: "specialColumnAdd.html",
            area: ['1000px', '540px'],
            btn: ['确定', '取消'],
            yes: function (index, layero) {
                ...
                var columnName=iframedoc.getElementById("title");
                var icon=iframedoc.getElementsByClassName("upload_imgname");
                var columnDesc=iframedoc.getElementById("columnDesc");
                var columInfoUrl=iframedoc.getElementById("columInfoUrl");
                $.ajax({
                    url:serverUrl + "/PoliceChangPing/programInfo/insertProgramInfo",
                    type:"POST",
    ...
    $(".btnEdit").click(function () {
        ...
        layui.layer.open({
            ...
            type: 2,
            content: "specialColumnEdit.html",
            area: ['1000px', '540px'],
            btn: ['确定', '取消'],
            yes: function (index, layero) {
            	//一级栏目修改接口数据
