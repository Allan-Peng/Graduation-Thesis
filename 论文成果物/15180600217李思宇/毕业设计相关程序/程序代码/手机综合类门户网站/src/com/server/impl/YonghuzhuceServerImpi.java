...
public class YonghuzhuceServerImpi implements YonghuzhuceServer {
   ...
   private YonghuzhuceMapper gdao;
	...
	@Override
	public int testInsert(Integer number) {
		// TODO Auto-generated method stub
		return gdao.testINSERT(number);
	}

	@Override
	public void addVideo(String count) {
		// TODO Auto-generated method stub
		gdao.addVideo(count);
	}
	...
	public List<String> findVideo() {
		// TODO Auto-generated method stub
		return gdao.findVideo();
	}



	@Override
	public List<String> findShuoming() {
		// TODO Auto-generated method stub
		return gdao.findShuoming();
	}

	@Override
	public void addVideo2(String shuoming) {
		// TODO Auto-generated method stub
		 gdao.addVideo2(shuoming);
	}
