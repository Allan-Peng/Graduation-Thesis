...
<div class="fxmain">
  ...
  <div class="fxmain_nr">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%'>标题：</td><td width='39%'>${xinwentongzhi.biaoti}</td>     <td width='11%'>类别：</td><td width='39%'>${xinwentongzhi.leibie}</td></tr><tr>     <td width='11%'>内容：</td><td width='39%'>${xinwentongzhi.neirong}</td>     <td width='11%'>点击率：</td><td width='39%'>${xinwentongzhi.dianjilv}</td></tr><tr>     <td width='11%'>添加人：</td><td width='39%'>${xinwentongzhi.tianjiaren}</td>     <td>&nbsp;</td><td>&nbsp;</td></tr><tr>							 
