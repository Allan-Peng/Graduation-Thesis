...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
	   请在此处上传发布会视频：
			 <form method="post" action="addVideo.do" enctype="multipart/form-data">
		&nbsp;&nbsp;&nbsp;
		&nbsp;
			 <input type="text" name="shuoming" style="display:block"></input>
				
				 <input	class="name" type="file" name="video" />			
