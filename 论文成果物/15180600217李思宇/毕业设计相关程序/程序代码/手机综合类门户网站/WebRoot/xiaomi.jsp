...
<c:otherwise>
		  <li><a href="login.jsp"> 后台管理</a></li>
            ...
            <div class="head-nav-con clearFloat">
                <ul>
                    <li class="drop-down" class="cur"><a href="#" style="margin-top:-8px;">视频相关</a>
                        <ul class="drop-down-content">
                            <li><a href="xiaomi.do">发布会</a></li>
...
<div class="fxmain">
  ...
  <div class="fx_fenlei">
     ...
     <div class="dqwz fr">
     当前位置：<a href="index.do">网站首页</a> &gt;发布会视频&gt; 发布会     </div> 
  </div>
  <!--顶部类别结束-->
  <!--详细内容的开始-->
...
<%--    <video width="320" height="240" controls>您的浏览器不支持video标签
 <source  src="video.do?imgName=1558250564259" type="video/mp4">
 </video> --%>
 

<%--     <c:forEach items="${url}" var="u">
     <video width="320" height="240" controls>您的浏览器不支持video标签
 		<source  src="video.do?imgName=${u }" type="video/mp4">
	 </video>
    </c:forEach>
  <c:forEach items="${shuomings}" var="shuo">
   <div style=" display: inline-block;width: 320px;">${shuo}</div>   
  </c:forEach> --%>
		 
  <c:forEach items="${shipin}" var="xx">
   <div style="float:left;margin-left:80px">
    <video width="320" height="240" controls>您的浏览器不支持video标签
 		<source  src="video.do?imgName=${xx.url}" type="video/mp4">
	 </video>
	 <p>${xx.des}</p>
	 </div>
