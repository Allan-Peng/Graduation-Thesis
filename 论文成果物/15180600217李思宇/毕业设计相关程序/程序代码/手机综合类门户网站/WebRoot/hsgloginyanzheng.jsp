...
<html>
 ...
 if(cx.equals("用户")){sql="select * from yonghuzhuce where yonghuming='"+uid+"' and mima='"+pwd+"' and issh='是'";}
 if(cx.equals("作者")){sql="select * from zuozhexinxi where zhanghao='"+uid+"' and mima='"+pwd+"' and issh='是'";}
 //quxanxiaxndexnglxu
