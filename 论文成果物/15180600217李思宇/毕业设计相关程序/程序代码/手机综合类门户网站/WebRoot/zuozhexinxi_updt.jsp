...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateZuozhexinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改作者信息<input type="hidden" name="id" value="${zuozhexinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.zhanghao.value='${zuozhexinxi.zhanghao}';</script>	<script language="javascript">document.form1.mima.value='${zuozhexinxi.mima}';</script>	<script language="javascript">document.form1.xingming.value='${zuozhexinxi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${zuozhexinxi.xingbie}';</script>	<script language="javascript">document.form1.nianling.value='${zuozhexinxi.nianling}';</script>	<script language="javascript">document.form1.shouji.value='${zuozhexinxi.shouji}';</script>	<script language="javascript">document.form1.shenfenzheng.value='${zuozhexinxi.shenfenzheng}';</script>	<script language="javascript">document.form1.jianjie.value='${zuozhexinxi.jianjie}';</script>	
					 </table>
			</form>
   </body>
</html>
