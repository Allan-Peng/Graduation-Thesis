...
<c:choose>
<c:when test ="${cao==7}"> <li class="cur" >	<a href="main.jsp">后台管理</a> </li>
</c:when>
<c:otherwise>
		  <li><a href="main.jsp"> 后台管理</a></li>
            ...
            <div class="head-nav-con clearFloat">
                <ul>
                    <li class="drop-down" ><a href="#" style="margin-top:-8px;">相关视频</a>
...
<!--底部的结束-->
 ...
 <source  src="video.do?imgType=MP4&imgName=1558250564259" type="video/mp4">
 </video>
</body>
</html>
