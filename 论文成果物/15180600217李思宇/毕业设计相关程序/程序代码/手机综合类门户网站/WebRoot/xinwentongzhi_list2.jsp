...
-->
    ...
    <td>${u.tianjiaren}</td>
                              ...
                              <td align="center"><a href="doUpdateXinwentongzhi.do?id=${u.id }">编辑</a>  <a href="deleteXinwentongzhi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="XinwentongzhiDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="xinwentongzhiList.do?page=1" >首页</a>
             <a href="xinwentongzhiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="xinwentongzhiList.do?page=${page.page+1 }">下一页</a>
			<a href="xinwentongzhiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
